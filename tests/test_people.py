...
def test_who_is_infected_list_valid():
    '''
    person4 nie został wypisany, poniewaz spotkal sie z person3, zanim ten zostal zarazony przez person2
    '''
    ...
    assert person1.who_is_infected(disease) == {'Jasper Haworth', 'Cally Fletcher', 'Carson Keeling'}
...
def test_who_is_infected_list_only_one():
    ...
    disease = Disease("Covid-19", 30)
    assert person1.who_is_infected(disease) == {'Carson Keeling', 'Jackson Black'}

def test_who_is_infected_list_infection_duration_pass():
    '''
        person4 pomimo spotkania z zarazonym person2 nie zostal zarazonym, bo czas zarazliwosci zostal przekroczony o minute
    '''
    person1 = Person("Carson", "Keeling")
    person2 = Person("Cally", "Fletcher")
    person4 = Person("Jackson", "Black")
    ...
    disease = Disease("Covid-19", 30)
    assert person1.who_is_infected(disease) == {'Carson Keeling', 'Cally Fletcher'}